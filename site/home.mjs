...
<main id="main">
  <section class="am-hero" aria-labelledby="hero-title">
    ...
    <div class="wrap am-hero-grid">
      ...
      <div class="am-hero-visual">
        ...
        <figure class="am-app-window"><div class="am-window-bar"><span class="am-window-lights" aria-hidden="true"><i></i><i></i><i></i></span><span>ALLMID / LEAGUE OF LEGENDS</span><span class="am-window-status">DESKTOP APP</span></div><img src="img/app/allmid-main.png" alt="AllMid desktop app showing the Mid tier list for League Classic, with champions graded S to D by win rate and the sample each grade rests on" width="1296" height="823" fetchpriority="high"><figcaption>Actual app screenshot</figcaption></figure>
  ...
  <section class="am-section am-universe" id="games" aria-labelledby="games-title">
    <div class="wrap am-universe-layout">
        <div class="am-universe-intro am-reveal"><p class="am-kicker">${icon("radar")} 01 / A BIGGER PLAYGROUND</p><h2 id="games-title">One companion.<br><em>A whole lot of possibility.</em></h2><p>Select a game. Explore what is available today, and what could come next.</p></div>
        ${gameRadar()}
  ...
  <section class="am-download" id="get"><div class="wrap"><div class="am-download-orbits" aria-hidden="true"></div><div class="am-download-copy"><p class="am-kicker">${icon("download")} READY WHEN YOU ARE</p><h2>Your next match.<br><em>A little more informed.</em></h2><p>Get the League Classic companion today. Be here for what comes next.</p></div><div class="am-download-action"><a class="btn btn-primary" href="${download}">${icon("download")} Download AllMid for Windows</a><p class="am-install-note">Windows 10 &amp; 11 <span>·</span> Free <span>·</span> No account</p></div></div></section>
</main>
