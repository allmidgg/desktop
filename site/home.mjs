...
<main id="main">
  <section class="am-hero" aria-labelledby="hero-title">
    ...
    <div class="wrap am-hero-grid">
      <div class="am-hero-copy">
        ...
        <div class="am-actions"><a class="btn btn-primary" href="${download}"><span aria-hidden="true">↓</span> Get AllMid for Windows</a><a class="am-watch" href="#experience"><span aria-hidden="true">▷</span> See how it works</a></div>
        <p class="am-install-note">Free &amp; open source <span>·</span> Windows 10 &amp; 11</p>
        <div class="am-current-module"><span class="am-tiny-icon">L</span><span><b>League of Legends</b><small>First module available · Classic data</small></span><a href="#games" aria-label="Explore all game modules">↗</a></div>
      </div>
      <div class="am-hero-visual">
        ...
        <div class="am-floating-insight"><span class="am-insight-symbol" aria-hidden="true">↗</span><div><small>CONTEXT, NOT CLUTTER</small><b>The numbers behind your play.</b><span>Every win rate carries its sample size.</span></div></div>
      </div>
    </div>
    <div class="wrap am-hero-bottom"><a href="#games" class="am-scroll-cue"><span aria-hidden="true">↓</span> EXPLORE THE UNIVERSE</a><button class="am-motion" type="button" aria-pressed="false" hidden><span aria-hidden="true">Ⅱ</span> <span data-motion-label>Pause motion</span></button></div>
  </section>

  <div class="am-proof-strip"><div class="wrap"><p><b>${num(stats.games)}</b><span>Classic games recorded</span></p><p><b>${num(stats.champions)}</b><span>Classic champions with data</span></p><p><b>Open source</b><span>Explore the code. Make it yours.</span></p><a href="classic.html">See the dataset <span aria-hidden="true">↗</span></a></div></div>

  <section class="am-section am-universe" id="games" aria-labelledby="games-title">
    <div class="wrap"><div class="am-section-head am-reveal"><div><p class="am-kicker">01 / A BIGGER PLAYGROUND</p><h2 id="games-title">One companion.<br><em>A whole lot of possibility.</em></h2></div><p>League is just the beginning of the ambition.<br>Select a game to see what is available today, and what could come next.</p></div>
  ...
  <section class="am-section am-experience" id="experience" aria-labelledby="experience-title">
    <div class="wrap"><div class="am-section-head am-reveal"><div><p class="am-kicker">02 / IN YOUR CORNER</p><h2 id="experience-title">Less searching.<br><em>More playing.</em></h2></div><p>Good information should be easy to find.<br>Here is what the League Classic module brings to your setup.</p></div>
      <div class="am-feature-tabs" role="tablist" aria-label="Explore League Classic features"><button id="tab-builds" role="tab" aria-selected="true" aria-controls="feature-builds" data-feature="builds" type="button"><span>01</span> Build insights</button><button id="tab-select" role="tab" aria-selected="false" aria-controls="feature-select" data-feature="select" tabindex="-1" type="button"><span>02</span> Matchup context</button><button id="tab-overlay" role="tab" aria-selected="false" aria-controls="feature-overlay" data-feature="overlay" tabindex="-1" type="button"><span>03</span> In-game overlay</button></div>
      ...
      <div class="am-principles"><article><span aria-hidden="true">↳</span><h3>Your client. Your machine.</h3><p>AllMid reads the local client and keeps its database on your device.</p></article><article><span aria-hidden="true">◎</span><h3>Numbers with a source.</h3><p>Sample sizes stay visible. Small samples are called out, not dressed up.</p></article><article><span aria-hidden="true">⌘</span><h3>Open from the start.</h3><p>No account required. Optional data sharing. Code you can inspect.</p></article></div>
    </div>
  </section>

  <section class="am-section am-data" id="classic-data" aria-labelledby="data-title">
    <div class="wrap"><div class="am-section-head am-reveal"><div><p class="am-kicker">03 / THE PROOF IS IN THE GAMES</p><h2 id="data-title">Real games.<br><em>Readable insights.</em></h2></div><div><p>A snapshot from League Classic.<br>Top overall win rates in our recorded dataset, pooled across lanes.</p><p class="am-dataset-date">Dataset updated ${esc(stats.date)}</p></div></div>
  ...
  <section class="am-section am-faq" id="faq" aria-labelledby="faq-title"><div class="wrap am-faq-layout"><div><p class="am-kicker">BEFORE YOU QUEUE</p><h2 id="faq-title">A few things<br><em>worth knowing.</em></h2><a class="am-link" href="mailto:contact@allmid.gg">Ask us something <span aria-hidden="true">↗</span></a></div><div class="am-faq-list">
  ...
  <section class="am-download" id="get"><div class="wrap"><div class="am-download-orbits" aria-hidden="true"></div><p class="am-kicker">READY WHEN YOU ARE</p><h2>Your next match.<br><em>A little more informed.</em></h2><p>Get the League Classic companion today.<br>Be here for what comes next.</p><a class="btn btn-primary" href="${download}"><span aria-hidden="true">↓</span> Download AllMid for Windows</a><p class="am-install-note">Windows 10 &amp; 11 <span>·</span> Free <span>·</span> No account</p></div></section>
</main>
